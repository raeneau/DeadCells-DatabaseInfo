...
import Astrolab from "../database/stable/level/MainLevels/20---Astrolab.json";
import Greenhouse from "../database/stable/level/MainLevels/24---Greenhouse.json";
import Swamp from "../database/stable/level/MainLevels/25---Swamp.json";
